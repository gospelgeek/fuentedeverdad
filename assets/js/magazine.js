...
if (book.turn('addPage', element, page)) {
    ...
    if (page !== 1  && page !== pages && page !== 2 && page !== 3 && page !== 50 && page !== 51) {
        if (lang == 'es') {
            ...
            if(page % 2 == 0){
                element.html('<div class="gradient"></div><div class="number-page" onclick=goPage(2)>' + (page-1) + '-Global Missions Publication</div>')
            }else{
                element.html('<div class="gradient"></div><div class="number-page" onclick=goPage(2)>Global Missions Publication-' + (page-1) + '</div>');
            }
        }
    } else {
...
function questions(e){
    ...
    .then(html => {
        ...
        for(i=2;i<tr.length;i++){
            ...
            if((td[4].innerText != '' && td[4].innerText !=' ') && (td[5].innerText != ' ' && td[5].innerText != '' && e == 'en')){
                ...
                const strong = document.createElement('strong');
                    strong.innerHTML = td[4].innerText;
            ...
            if((td[1].innerText != '' && td[1].innerText !=' ') && (td[3].innerText != ' ' && td[3].innerText != '' && e == 'es')){
                const li = document.createElement('li');
                li.setAttribute('class','item');
